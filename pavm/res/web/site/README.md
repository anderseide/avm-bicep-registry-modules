...
>**Note**: To reference the module, please use the following syntax `br/private:pavm/res/web/site:<version>`.
...
```bicep
module site 'br/private:pavm/res/web/site:<version>' = {
  name: 'siteDeployment'
  params: {
    // Required parameters
    kind: 'functionapp'
...
```bicep-params
using 'br/private:pavm/res/web/site:<version>'
