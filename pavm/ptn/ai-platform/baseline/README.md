...
>**Note**: To reference the module, please use the following syntax `br/private:pavm/ptn/ai-platform/baseline:<version>`.
...
```bicep
module baseline 'br/private:pavm/ptn/ai-platform/baseline:<version>' = {
...
```bicep-params
using 'br/private:pavm/ptn/ai-platform/baseline:<version>'
